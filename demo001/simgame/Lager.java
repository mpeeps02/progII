...
public class Lager extends Arbeitsstelle {
	...
	/**
	 * Ort, in dem das Lager platziert wird. Die Funktionalitaet ist nicht vom
	 * Ortsnamen abhaengig. Der Ort kann beliebig gewaehlt werden und dient
	 * lediglich der Illustration im Spiel.
	 */
	// private String ort; --> bereits in Oberklasse vorhanden

	/**
	 * Erfassung der Warenarten im Lager und der jeweiligen Lagerbestaende. Wenn
	 * eine Warenart nicht im Lager vorhanden ist, wird sie auch in dieser HashMap
	 * nicht gefuehrt.
	 */
	 ...
	 */
	public Lager(String ort, int anzahlarbeiter, int lohnhoehe) {
		super(ort, anzahlarbeiter, lohnhoehe); // --> nur die in der Oberklasse definierten Attribute
	}

	/**
	 * Einlagern von Waren einer bestimmten Warenart mit einer bestimmten Menge. Mit
	 * dem Aufruf wird der Lagerbestand entsprechend erhoeht.
	 * 
	 * @param warenart       die Warenart, welche eingelagert werden soll
	 * @param mengeEinlagern die Menge der genannten Warenart, die eingelagert
	 *                       werden soll
	 */
	public void einlagern(Warenart warenart, int mengeEinlagern) {
		if (lagerbestand.containsKey(warenart)) {
			// es gibt schon einen Bestand der Warenart, also muss die bisher gelagerte
			// Menge zur
	...
	/**
	 * Verkaufen von Waren fuehrt zum Verringern von Warenbestand der genannten
	 * Warenart. Wenn weniger als die zu verkaufende Menge im Lager vorhanden ist,
	 * dann wird der gesamte Bestand der betreffenden Warenart verkauft.
	 * 
	 ...
	 * @return Erloes in Taler, der durch den Verkauf zum genannten Preis erzielt
	 *         wird
	 */
	...
	/**
	 * @return ein Set mit allen Warenarten, die gerade mit einer Menge > 0 im Lager
	 *         eingelagert sind
	 */
	 ...
	 * @return Anzahl der Wareneinheiten, die im Lager von der angegebenen Warenart
	 *         vorhanden sind
	 */
